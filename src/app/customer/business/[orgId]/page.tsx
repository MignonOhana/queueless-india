               ...
               >
                  ...
                  <div className="space-y-3">
                     <button 
                       ...
                       className="w-full bg-gradient-to-r from-orange-500 to-rose-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-orange-500/30 hover:brightness-110 active:scale-95 transition-all"
                     >
