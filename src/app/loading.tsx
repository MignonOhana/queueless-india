...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-[999] bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-2xl flex flex-col items-center justify-center animate-in fade-in duration-500">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="w-24 h-24 mb-8 relative flex items-center justify-center">
          <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-orange-500 to-rose-500 animate-ping opacity-20"></div>
